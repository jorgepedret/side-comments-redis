...
var Comments = module.exports = new Thug({
  filters: {
    in: [],
    beforeValidate: [],
    beforeWrite: [],
...
// Write
Comments.constructor.prototype.write = function (id, comment, cb) {
...
// Read
Comments.constructor.prototype.read = function (id, cb) {
...
// Remove
Comments.constructor.prototype.remove = function (id, cb) {
  var key = "comment:" + id;
